...
int32_t NotepadViewModel::CharCount() const {
	return m_charCount;
}
int32_t NotepadViewModel::LineCount() const {
	return m_lineCount;
}
int32_t NotepadViewModel::WordCount() const {
	return m_wordCount;
}
...
int32_t NotepadViewModel::CursorLine() const {
	return m_cursorLine;
}
...
int32_t NotepadViewModel::CursorColumn() const {
